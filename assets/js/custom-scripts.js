(function($) {
  "use strict";
    ...
    addScene("#section2", new TweenMax.from(".section2 .ev-content-title span", 5, {
        opacity: 0,
        y: 70,
        ease: Power1.easeOut
    }).delay(.2)),
    ...
    addScene("#section3", new TweenMax.from(".section3 .ev-content-title span", 5, {
        opacity: 0,
        y: 70,
        ease: Power1.easeOut
    }).delay(.5)),
    ...
    addScene("#section4", new TweenMax.from(".section4 .ev-content-title span", 5 , {
        opacity: 0,
        y: 70,
        ease: Power1.easeOut
    }).delay(.5)),
  ...
  addScene("#section7", new TweenMax.from(".section7 .ev-content-title span", 5, {
      opacity: 0,
      y: 70,
      ease: Power1.easeOut
  }).delay(.5)),
